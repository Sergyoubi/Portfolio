...
const Intro = () => {
  return (
    <section className="w-full h-[100vh] 2xl:h-[70vh] flex justify-center lg:justify-end items-center">
      <div className="w-[85%] h-[70%] lg:w-[50%] lg:h-[68%] xl:h-[70%] mid-xl:h-[55%] 2xl:h-[70%] flex flex-col justify-between lg:justify-start items-center gap-5 relative mid-xl:bottom-[8%] 2xl:bottom-[-6%]">
